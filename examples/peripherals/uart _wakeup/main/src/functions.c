 ...
 * @author      Manuel Caballero
 * @date        08/April/2026
 * @version     26/April/2026   UART wakeup functionality added.
 *              08/April/2026   The ORIGIN
 * @pre         N/A
 * @warning     N/A
 */
void conf_UART (uint32_t baudrate)
{
    ...
    /* Light-sleep mode:    UART_wakeup functionality    */
    uart_set_wakeup_threshold(UART_NUM_1, 3U);
